...
PowerShell из корня `trposite`:

```powershell
tar -xf trposite_ai_explain_patch.tar
```

Архив содержит только изменённые и новые файлы, поэтому существующие остальные файлы проекта не затрагиваются.
